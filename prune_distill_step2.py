...
def train_model():
    ...
    pruned_model = torch.load(model_path, weights_only=False)
...
############################################get initial grad for importance estimation############################################
        ...
        #########################################################################################################
        print("===========================Bottleneck Pruning Start===========================")
        #Bottleneck Pruning
        model.cpu().eval()
